...
import { achievementAdd, clearMessage } from "../../store/Reducers/achievementReducer";
...
const AddAchievement = () => {
  ...
  const handleSubmit = (e) => {
    ...
    dispatch(achievementAdd(submitData));
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-neutral-50 via-white to-primary-50/30 px-2 py-5 lg:px-7">
      <div className="w-full rounded-2xl bg-white p-6 shadow-nature-medium ring-1 ring-primary-100">
        <HeaderText title="Add Achievement" />
          ...
          <form onSubmit={handleSubmit} className="mt-5">
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              ...
              <div className="md:col-span-2">
                ...
                <p className="mt-1 text-xs text-text-light">
                  Optional: Upload an image (takes precedence over URL)
                </p>
              </div>
            </div>
