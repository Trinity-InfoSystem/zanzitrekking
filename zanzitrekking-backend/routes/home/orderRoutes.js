...
const { generateMissingPaymentLinks } = require('../../utilities/generateMissingPaymentLinks')
...
router.get('/customer/:customerId/history', orderController.getCustomerOrderHistory)
router.get('/customer/:customerId/statistics', orderController.getCustomerOrderStatistics)
